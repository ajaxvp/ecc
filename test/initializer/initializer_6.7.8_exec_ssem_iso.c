/* ISO: 6.7.8; ISO C static storage duration semantics tests */
...
int main(void)
{
    ...
    static char s1[] = "abc", t1[3] = "abc";
    static char s2[] = { 'a', 'b', 'c', '\0' }, t2[] = { 'a', 'b', 'c' };
    ...
    static struct { int a[3], b; } w2[] = { [0].a = { 1 }, [1].a[0] = 2 };
